      ...
      <div class="flex flex-col md:flex-row gap-6">
        ...
        <div class="flex-1 flex flex-col justify-between">
          <div>
            ...
            <p class="text-2xl font-semibold mb-4">R$ {{ product.price }}</p>
          </div>
          ...
          <div class="flex gap-4">
            ...
            />
            <router-link to="/">
              <Button label="Voltar" class="bg-gray-300 hover:bg-gray-400 text-gray-900" />
            </router-link>
          </div>
        </div>
      </div>
...
<style scoped>
/* Pode adicionar algum estilo específico se quiser */
</style>